...
별표(*) 표시된 부분만 입력하면 되는데, 국세 관련 정보를 받을 휴대폰 번호랑 전자메일 주소는 입력할 것을 추천

​
그리고 사업장 소재지의 경우, 살고 있는 주소랑 동일하면 '여' 아니면 '부'를 클릭하면 된다


'여'를 클릭하면 자동으로 현주소가 뜨고, '부'를 클릭하면 사업장 주소를 입력하면 된다
...
전자상거래 소매업은 일반 온라인 판매이고, 전자상거래 소매 중개업은 구매대행이라고 생각하면 된다


이름을 더블 클릭하면 선택되고 주업종, 부업종으로 선택하면 여러 업종도 선택가능하다
...
개업일자는 임의로 정해서 입력하면 되고, 임대차 내역의 경우에는 자가면적 임의로 입력하면 된다
...
동업자가 없으면 공동사업자 선정을 없음이라고 선택하면 된다


사업자 유형은 보통 일반이나 간이 사업자인데, 간이과세자는 보통 4,800만원 미만인 개인 사업자로 법인은 불가하다
...
임대 사업장이거나 동업, 허가업종의 경우에는 해당 서류를 첨부해야되지만


자가에서 홀로 일하는 개인 사업장의 경우에는 따로 첨부할 서류가 없으므로, 그냥 무시하고 다음만 누르면 된다
